...
(function () {
  ...
  var intents = [
    ...
    { id: "universidad", chips: "La Universidad", kw: ["autoridades", "rector", "normativa", "reglamento", "estatuto", "planificacion", "identidad", "organizacion", "historia"], a: "En el menú “La UTEQ” encuentras autoridades, normativa institucional, planificación estratégica e identidad corporativa." },
    { id: "admision", chips: "Admisión", kw: ["admision", "postular", "postulacion", "inscribir", "inscripcion", "ingreso", "matricula", "matricularme", "cupo", "requisitos"], a: "El proceso de admisión está en el menú Oferta académica → Admisión, con el botón “Conoce la UTEQ” en la portada." },
    { id: "carreras", chips: "Carreras", kw: ["carrera", "carreras", "estudiar", "malla", "oferta academica"], a: "La UTEQ ofrece 39 carreras distribuidas en varias facultades. Puedes verlas todas en la sección “Estudia con nosotros”." },
    { id: "agenda", chips: "Agenda", kw: ["agenda", "calendario", "fechas", "cronograma"], a: "La sección Agenda muestra el mini calendario y las próximas fechas importantes: matrículas, inicio de clases y actividades de bienestar." },
    { id: "noticias", chips: "Noticias", kw: ["noticia", "noticias", "novedades", "actualidad", "eventos"], a: "Las últimas noticias institucionales están en la sección Noticias, con actualidad de investigación, graduaciones, becas y convenios." },
